...
from wrappers import saturnin_encrypt_message, twinkle_decrypt_message
...
def recv_loop(sock: socket.socket):
    ...
    for line in f:
        ...
        # Sreya -> Kriti messages are encrypted with TWINKLE
        try:
            plaintext = twinkle_decrypt_message(BASE_KEY_HEX, ct_hex)
...
def send_loop(sock: socket.socket):
    while True:
        ...
        if not msg:
            continue
        # Kriti sends using SATURNIN
        ct_hex = saturnin_encrypt_message(msg, BASE_KEY_HEX)
